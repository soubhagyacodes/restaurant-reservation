   ...
   return (
      ...
      <div className="md:grid grid-cols-4">
         ...
         <div className="btns col-span-1 flex flex-col items-center justify-center md:gap-6 gap-3 pb-5 md:pb-0">
            ...
            {old ? <Button className="bg-gray-500/90 h-12 md:w-50 w-full" disabled><Trash2/>Cancel Reservation</Button> : (reservationStatus != "CANCELLED" ? <Button className="bg-red-500/90 h-12 md:w-50 w-full hover:bg-red-500/80" onClick={btnHandler} ><Trash2 />Cancel Reservation</Button> : (loading ? <Button className="bg-red-500/90 h-12 w-50" disabled><Loader2Icon className="animate-spin"/>Cancel Reservation</Button> : <Button className="bg-red-500/90 h-12 w-50" disabled><Trash2/>Cancel Reservation</Button>))}
